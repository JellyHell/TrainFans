...
public class AttendClassHomeAdapter extends
        SectionedRecyclerViewAdapter<SectionHeaderHolder,AttendClassHomeViewHolder,SignUpFooterHolder,RecyclerView.ViewHolder> {

    private Context mContext;

    public ArrayList<Article> mRecords = new ArrayList<>();

    public AttendClassHomeAdapter(Context context,ArrayList<Article> records) {
        mContext = context;
    ...
    protected int getResourceId() {
        return R.layout.viewholder_attendclass_record_layout;
    }
    ...
    @Override
    protected AttendClassHomeViewHolder onCreateItemViewHolder(View arg0) {
        return new AttendClassHomeViewHolder(arg0);
    }
    ...
    @Override
    protected void onBindItemViewHolder(final AttendClassHomeViewHolder holder, int section, int position) {
        //Cell信息显示
