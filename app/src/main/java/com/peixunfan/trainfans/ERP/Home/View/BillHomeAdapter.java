...
public class BillHomeAdapter  extends BaseSwipMenuAdapter<Article> {

    public BillHomeAdapter(Context context, ArrayList<Article> datas) {
        super(context, datas);
    }

    @Override
    protected int getResourceId() {
        return R.layout.adapter_billhomelist_item;
    }
