...
public class TeacherClassFragment  extends BaseFragment implements Observer<ArticleList>
{
    ...
    private void setApapter(){
        if(mAdapter == null){
            mAdapter = new TeacherClassAdapter(getActivity(),mArticleList);
