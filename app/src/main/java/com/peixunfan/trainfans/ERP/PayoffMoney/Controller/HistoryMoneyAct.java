...
import com.peixunfan.trainfans.ERP.PayoffMoney.View.PayHistoryListAdapter;
...
public class HistoryMoneyAct  extends BaseActivity implements Observer<ArticleList> {
    ...
    private void setApapter(){
        if(mAdapter == null){
            mAdapter = new PayHistoryListAdapter(this,mStudentList);
            mRefreshableRecyclerView.setAdapter(mAdapter);
            mAdapter.setOnItemClickListener((parent, view, position, id) -> IntentUtil.forwordToActivity(HistoryMoneyAct.this,PayoffMoneyCountAct.class));
        }else {
