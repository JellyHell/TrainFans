...
public abstract class IntentStudentSwipeMenuAdapter <T>  extends SwipeMenuAdapter<RecyclerView.ViewHolder> {

    protected IntentStudentSwipeMenuAdapter() {
    }
    ...
    private com.peixunfan.trainfans.Base.BaseSwipMenuAdapter.RecyclerAdapterListener mListener;
    protected AdapterView.OnItemClickListener mItemClickListener;
    private static final int HEADER = 0;
    public static final int ITEM_NROMAL = 1;
    public static final int ITEM_HIGHTER = 3;
    private static final int FOOTER = 2;

    public IntentStudentSwipeMenuAdapter(Context context, ArrayList<T> datas) {
        mContext = context;
        mDatas = datas;
    ...
    public void setLoadMoreListener(com.peixunfan.trainfans.Base.BaseSwipMenuAdapter.RecyclerAdapterListener pListener) {
        mListener = pListener;
    }
