...
public class StudentAdapter extends BaseSwipMenuAdapter<Article> {

    public StudentAdapter(Context context, ArrayList<Article> datas) {
        super(context, datas);
    }
    ...
    protected RecyclerView.ViewHolder onCreateItemHolderViewHolder(View arg0) {
        return new StudentAdapter.ItemViewHolder(arg0, this.mContext);
    }

    @Override
    protected void onBindContentViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        final StudentAdapter.ItemViewHolder aItemViewHolder = (StudentAdapter.ItemViewHolder) viewHolder;
        // 点击事件
