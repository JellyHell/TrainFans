...
public class CouserTeacherFragment  extends BaseFragment implements Observer<ArticleList>
{
    @Bind(R.id.container_layout)
    RelativeLayout mContainer;

    @Bind(R.id.rlv_addteacher_layout)
    RelativeLayout mAddTeacherlayout;
    ...
    protected void initView() {
        ...
        mRefreshableRecyclerView.getRecyclerview().setSwipeMenuItemClickListener((closeable, adapterPosition, menuPosition, direction) -> {
            ...
            mTeacherList.remove(adapterPosition);
            mAdapter.notifyItemRemoved(adapterPosition);
        });

//        mAddTeacherlayout.setOnClickListener(view -> IntentUtil.forwordToActivity(getActivity(),));
    }
