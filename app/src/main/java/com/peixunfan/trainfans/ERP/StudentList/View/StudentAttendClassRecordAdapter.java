...
public class StudentAttendClassRecordAdapter  extends BaseAdapter<Article> {

    public StudentAttendClassRecordAdapter(Context context, ArrayList<Article> datas) {
        super(context, datas);
    }

    @Override
    protected int getResourceId() {
        return R.layout.adapter_attendclass_record_item;
    }
