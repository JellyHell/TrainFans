...
public class SendSMSClassFragment extends BaseFragment implements Observer<ArticleList> {
    ...
    ArrayList<Article> mClassList = new ArrayList();
    ...
    private void setApapter(){
        if(mAdapter == null){
            mAdapter = new ClassAdapter(getActivity(),mClassList);
            mAdapter.setOnItemClickListener((adapterView, view, i, l) -> {

                IntentUtil.forwordToActivity(getActivity(),SendMsgAct.class);
    ...
    public void onNext(ArticleList articleList) {
        ...
        mClassList.addAll(articleList.borrowList);
