...
public class SuperToast {
	...
	public static class Duration {
		public static final int VERY_VERY_SHORT = (2000);
		public static final int VERY_SHORT = (2000);
		public static final int SHORT = (2000);
		public static final int MEDIUM = (2000);
		public static final int LONG = (5000);
		public static final int EXTRA_LONG = (5000);
		public static final int VERY_VERY_VERY_LONG = (1000);
	...
	private int mGravity = Gravity.CENTER_VERTICAL | Gravity.CENTER;
	private int mDuration = Duration.EXTRA_LONG;
	...
	public SuperToast(Context context) {
		...
		mToastView = layoutInflater.inflate(R.layout.widgt_supertoast, null);
	...
	private int getAnimation() {
		...
		if (mAnimations == Animations.FLYIN) {
			...
			return R.style.topin_bottomout;
	...
	public static void show(String msg, Context aContext, boolean isShort) {
		if (msg != null && msg.length() > 0) {
			SuperToast aSuperToast = SuperToast.create(aContext, msg, Duration.VERY_VERY_SHORT, Animations.POPUP);
			aSuperToast.setBackground(SuperToast.Background.BLACK);
			aSuperToast.show();
		}
	}
