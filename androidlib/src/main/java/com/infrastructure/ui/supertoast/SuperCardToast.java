...
import com.infrastructure.ui.supertoast.SuperToast.Animations;
import com.infrastructure.ui.supertoast.SuperToast.IconPosition;
import com.infrastructure.ui.supertoast.SuperToast.Type;
...
public class SuperCardToast {
	...
	private SuperToast.Animations mAnimations = Animations.FADE;
	...
	public SuperCardToast(Activity activity) {
		...
		mToastView = mLayoutInflater.inflate(R.layout.widgt_supertoast, mViewGroup, false);
	...
	public SuperCardToast(Activity activity, Type type) {
		...
		if (type == Type.BUTTON) {
			...
			mToastView = mLayoutInflater.inflate(R.layout.widgt_supertoast_button, mViewGroup, false);
			...
			mToastView = mLayoutInflater.inflate(R.layout.widgt_supertoast_progresscircle, mViewGroup, false);
	...
	public SuperCardToast(Activity activity, Type type, Style style) {
		...
		if (type == Type.BUTTON) {
			...
			mToastView = mLayoutInflater.inflate(R.layout.widgt_supertoast_progresshorizontal, mViewGroup, false);
	...
	/**
	 * Sets the message {@link Typeface} style of the
	 * {@value #TAG}.
	 *
	 * @param typeface
	 *            {@link Typeface}
	...
	/**
	 * Returns the message {@link Typeface} style of the
	 * {@value #TAG}.
	 *
	 * @return int
	 */
