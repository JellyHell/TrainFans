...
public class SwipeMenuRecyclerView extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if(adapter instanceof com.yanzhenjie.recyclerview.swipe.touch.SwipeMenuAdapter){
            com.yanzhenjie.recyclerview.swipe.touch.SwipeMenuAdapter menuAdapter = (com.yanzhenjie.recyclerview.swipe.touch.SwipeMenuAdapter) adapter;
            menuAdapter.setSwipeMenuCreator(mDefaultMenuCreator);
            menuAdapter.setSwipeMenuItemClickListener(mDefaultMenuItemClickListener);
        }
